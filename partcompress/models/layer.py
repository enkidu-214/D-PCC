...
class DownsampleLayer(nn.Module):
    ...
    def get_density(self, sampled_xyzs, xyzs):
        ...
        for i in range(batch_size):
            uniques, counts = torch.unique(ori2sample_idx[i].long(), return_counts=True)
        ...
        return downsample_num, mask, knn_idx
    ...
    def forward(self, xyzs, feats):
        ...
        downsample_num, mask, knn_idx = self.get_density(sampled_xyzs, xyzs)
        identity = feats
        ...
        return sampled_xyzs, sampled_feats
